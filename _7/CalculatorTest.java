...
class CalculatorTest {
    ...
    void exercise1() {
        ...
        Assertions.assertEquals(36, calculator.add(15,21));
        Assertions.assertEquals(-14, calculator.add(-23,9));
        Assertions.assertEquals(0, calculator.add(12,-12));

        Assertions.assertEquals(4, calculator.subtract(10,6));
        Assertions.assertEquals(0, calculator.subtract(10,10));
        Assertions.assertEquals(-2, calculator.subtract(10,12));
    }
    ...
    void exercise2() {
        ...
        Assertions.assertEquals(36, calculator.divide(108,3));
        Assertions.assertEquals(14, calculator.divide(196,14));
    }
    ...
    void exercise3() {
        ...
        Assertions.assertEquals(0, calculator.power(0,3));
